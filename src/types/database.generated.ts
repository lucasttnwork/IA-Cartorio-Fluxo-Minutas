...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      chat_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "chat_sessions_draft_id_fkey"
            columns: ["draft_id"]
            isOneToOne: false
      ...
      graph_edges: {
        ...
        Relationships: [
          {
            foreignKeyName: "graph_edges_case_id_fkey"
            columns: ["case_id"]
            isOneToOne: false
            referencedRelation: "cases"
            referencedColumns: ["id"]
      ...
      merge_suggestions: {
        ...
        Relationships: [
          {
            foreignKeyName: "merge_suggestions_case_id_fkey"
            columns: ["case_id"]
            isOneToOne: false
            referencedRelation: "cases"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "merge_suggestions_person_a_id_fkey"
            columns: ["person_a_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "merge_suggestions_person_b_id_fkey"
            columns: ["person_b_id"]
            isOneToOne: false
            referencedRelation: "people"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "merge_suggestions_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      operations_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "operations_log_case_id_fkey"
            columns: ["case_id"]
            isOneToOne: false
            referencedRelation: "cases"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "operations_log_draft_id_fkey"
            columns: ["draft_id"]
            isOneToOne: false
            referencedRelation: "drafts"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_current_user_admin_or_supervisor: { Args: never; Returns: boolean }
    }
    Enums: {
      [_ in never]: never
    }
